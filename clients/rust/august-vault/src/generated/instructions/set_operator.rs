...
impl SetOperator {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: SetOperatorInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
impl<'a, 'b> SetOperatorCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = SetOperatorInstructionArgs {
                                                              new_operator: self.instruction.new_operator.clone().expect("new_operator is not set"),
                                    };
