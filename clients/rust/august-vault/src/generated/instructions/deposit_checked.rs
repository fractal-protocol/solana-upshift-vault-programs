...
impl DepositCheckedBuilder {
    ...
    #[inline(always)]
    pub fn sender_share_account(
        &mut self,
        sender_share_account: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = DepositChecked {
            ...
            sender_share_account: self
                .sender_share_account
                .expect("sender_share_account is not set"),
        ...
        let args = DepositCheckedInstructionArgs {
            ...
            min_shares_out: self
                .min_shares_out
                .clone()
                .expect("min_shares_out is not set"),
        };
...
impl<'a, 'b> DepositCheckedCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn vault_token_ata(
        &mut self,
        vault_token_ata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn sender_share_account(
        &mut self,
        sender_share_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = DepositCheckedCpi {
            ...
            vault_token_ata: self
                .instruction
                .vault_token_ata
                .expect("vault_token_ata is not set"),
