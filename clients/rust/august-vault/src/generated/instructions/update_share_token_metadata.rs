...
pub const UPDATE_SHARE_TOKEN_METADATA_DISCRIMINATOR: [u8; 8] =
    [33, 144, 157, 164, 161, 4, 219, 121];
...
impl UpdateShareTokenMetadata {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdateShareTokenMetadataInstructionData::new()
            .try_to_vec()
            .unwrap();
