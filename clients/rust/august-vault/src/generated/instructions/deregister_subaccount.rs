...
pub const DEREGISTER_SUBACCOUNT_DISCRIMINATOR: [u8; 8] = [112, 91, 26, 5, 186, 249, 34, 151];

/// Accounts.
#[derive(Debug)]
pub struct DeregisterSubaccount {
...
impl DeregisterSubaccount {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = DeregisterSubaccountInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct DeregisterSubaccountInstructionData {
            discriminator: [u8; 8],
      }

impl DeregisterSubaccountInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [112, 91, 26, 5, 186, 249, 34, 151],
                  }
  }
...
impl Default for DeregisterSubaccountInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `DeregisterSubaccount`.
///
/// ### Accounts:
///
...
pub struct DeregisterSubaccountBuilder {
...
impl DeregisterSubaccountBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = DeregisterSubaccount {
  ...
  /// `deregister_subaccount` CPI accounts.
  pub struct DeregisterSubaccountCpiAccounts<'a, 'b> {
...
/// `deregister_subaccount` CPI instruction.
pub struct DeregisterSubaccountCpi<'a, 'b> {
...
impl<'a, 'b> DeregisterSubaccountCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: DeregisterSubaccountCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `DeregisterSubaccount` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` vault_state
          ...
          ///   2. `[]` deposit_mint
                      ///   3. `[writable, signer]` admin
#[derive(Clone, Debug)]
pub struct DeregisterSubaccountCpiBuilder<'a, 'b> {
  instruction: Box<DeregisterSubaccountCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DeregisterSubaccountCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(DeregisterSubaccountCpiBuilderInstruction {
      __program: program,
              vault_state: None,
              subaccount: None,
              deposit_mint: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = DeregisterSubaccountCpi {
...
#[derive(Clone, Debug)]
struct DeregisterSubaccountCpiBuilderInstruction<'a, 'b> {
