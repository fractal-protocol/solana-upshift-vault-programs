...
impl AcceptAdminNomination {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = AcceptAdminNominationInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl AcceptAdminNominationBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = AcceptAdminNomination {
            ...
            nominated_admin_pda: self
                .nominated_admin_pda
                .expect("nominated_admin_pda is not set"),
...
impl<'a, 'b> AcceptAdminNominationCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn nominated_admin_pda(
        &mut self,
        nominated_admin_pda: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
