...
pub const SET_FEE_RECIPIENT_DISCRIMINATOR: [u8; 8] = [227, 18, 215, 42, 237, 246, 151, 66];
...
impl SetFeeRecipient {
  pub fn instruction(&self, args: SetFeeRecipientInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetFeeRecipientInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = SetFeeRecipientInstructionData::new().try_to_vec().unwrap();
...
impl Default for SetFeeRecipientInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetFeeRecipientInstructionArgs {
                  pub new_fee_recipient: Pubkey,
      }

impl SetFeeRecipientInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
...
/// Instruction builder for `SetFeeRecipient`.
///
/// ### Accounts:
///
...
pub struct SetFeeRecipientBuilder {
...
impl SetFeeRecipientBuilder {
  pub fn new() -> Self {
    ...
    pub fn admin(&mut self, admin: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn new_fee_recipient(&mut self, new_fee_recipient: Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SetFeeRecipient {
          ...
          let args = SetFeeRecipientInstructionArgs {
                                                              new_fee_recipient: self.new_fee_recipient.clone().expect("new_fee_recipient is not set"),
                                    };
  ...
  /// `set_fee_recipient` CPI accounts.
  pub struct SetFeeRecipientCpiAccounts<'a, 'b> {
...
/// `set_fee_recipient` CPI instruction.
pub struct SetFeeRecipientCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: SetFeeRecipientInstructionArgs,
  }

impl<'a, 'b> SetFeeRecipientCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: SetFeeRecipientCpiAccounts<'a, 'b>,
...
/// Instruction builder for `SetFeeRecipient` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` vault_state
          ///   1. `[]` deposit_mint
                ///   2. `[signer]` admin
#[derive(Clone, Debug)]
pub struct SetFeeRecipientCpiBuilder<'a, 'b> {
  instruction: Box<SetFeeRecipientCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetFeeRecipientCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SetFeeRecipientCpiBuilderInstruction {
      __program: program,
              vault_state: None,
              deposit_mint: None,
              admin: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = SetFeeRecipientInstructionArgs {
                                                              new_fee_recipient: self.instruction.new_fee_recipient.clone().expect("new_fee_recipient is not set"),
                                    };
        let instruction = SetFeeRecipientCpi {
...
#[derive(Clone, Debug)]
struct SetFeeRecipientCpiBuilderInstruction<'a, 'b> {
