...
pub const SET_FULFILLMENT_WINDOW_DISCRIMINATOR: [u8; 8] = [107, 18, 240, 153, 114, 108, 105, 120];

/// Accounts.
#[derive(Debug)]
pub struct SetFulfillmentWindow {
...
pub struct SetFulfillmentWindowInstructionData {
    discriminator: [u8; 8],
}

impl SetFulfillmentWindowInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [107, 18, 240, 153, 114, 108, 105, 120],
        }
    }
...
impl Default for SetFulfillmentWindowInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SetFulfillmentWindowInstructionArgs {
    pub seconds: u64,
}

impl SetFulfillmentWindowInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `SetFulfillmentWindow`.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
impl SetFulfillmentWindowBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = SetFulfillmentWindow {
...
/// `set_fulfillment_window` CPI accounts.
pub struct SetFulfillmentWindowCpiAccounts<'a, 'b> {
...
pub struct SetFulfillmentWindowCpi<'a, 'b> {
...
impl<'a, 'b> SetFulfillmentWindowCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SetFulfillmentWindowCpiAccounts<'a, 'b>,
        args: SetFulfillmentWindowInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetFulfillmentWindow` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
impl<'a, 'b> SetFulfillmentWindowCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetFulfillmentWindowCpiBuilderInstruction {
            __program: program,
            queue: None,
            vault_state: None,
            admin: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = SetFulfillmentWindowCpi {
...
#[derive(Clone, Debug)]
struct SetFulfillmentWindowCpiBuilderInstruction<'a, 'b> {
