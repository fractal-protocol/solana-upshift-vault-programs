...
pub const SET_FINALIZER_AUTHORITY_DISCRIMINATOR: [u8; 8] = [58, 227, 180, 125, 245, 175, 225, 161];

/// Accounts.
#[derive(Debug)]
pub struct SetFinalizerAuthority {
...
impl SetFinalizerAuthority {
    pub fn instruction(
        &self,
        args: SetFinalizerAuthorityInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = SetFinalizerAuthorityInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct SetFinalizerAuthorityInstructionData {
    discriminator: [u8; 8],
}

impl SetFinalizerAuthorityInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [58, 227, 180, 125, 245, 175, 225, 161],
        }
    }
...
impl Default for SetFinalizerAuthorityInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SetFinalizerAuthorityInstructionArgs {
    pub authority: Pubkey,
}

impl SetFinalizerAuthorityInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `SetFinalizerAuthority`.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
pub struct SetFinalizerAuthorityBuilder {
...
impl SetFinalizerAuthorityBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
...
/// `set_finalizer_authority` CPI accounts.
pub struct SetFinalizerAuthorityCpiAccounts<'a, 'b> {
...
/// `set_finalizer_authority` CPI instruction.
pub struct SetFinalizerAuthorityCpi<'a, 'b> {
    ...
    pub __args: SetFinalizerAuthorityInstructionArgs,
}

impl<'a, 'b> SetFinalizerAuthorityCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SetFinalizerAuthorityCpiAccounts<'a, 'b>,
        args: SetFinalizerAuthorityInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetFinalizerAuthority` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` queue
...
///   2. `[signer]` admin
#[derive(Clone, Debug)]
pub struct SetFinalizerAuthorityCpiBuilder<'a, 'b> {
    instruction: Box<SetFinalizerAuthorityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetFinalizerAuthorityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetFinalizerAuthorityCpiBuilderInstruction {
            __program: program,
            queue: None,
            vault_state: None,
            admin: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = SetFinalizerAuthorityCpi {
...
#[derive(Clone, Debug)]
struct SetFinalizerAuthorityCpiBuilderInstruction<'a, 'b> {
